...
class Client(models.Model):
    eik = models.CharField(max_length=20, unique=True, validators=[validate_eik_only_digits], verbose_name="ЕИК", help_text="Единен идентификационен код (само цифри).")
    ...
    apartment = models.PositiveIntegerField(blank=True, null=True, verbose_name="апартамент")
    represented_together = models.BooleanField(default=False, verbose_name="Фирмата се представлява съвместно от двама")
    representative1 = models.CharField(max_length=255, verbose_name="Три имена на представляващия дружеството")
