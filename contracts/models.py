...
class Currency(models.Model):
    currency_code = models.CharField(max_length=3, unique=True, verbose_name="валута код")
...
class Contract(models.Model):
    ...
    currency = models.ForeignKey(Currency, on_delete=models.SET_NULL, null = True, default='EUR', verbose_name = "валута")
